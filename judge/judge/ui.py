...
class HUD(object):
    ...
    # def tick(self, world: World, player: Vehicle, clock):
    ...
    #     colhist = player.collision_sensor.get_collision_history()
    ...
    #         "Accelero: (%5.1f,%5.1f,%5.1f)" % (player.imu_sensor.accelerometer),
    #         "Gyroscop: (%5.1f,%5.1f,%5.1f)" % (player.imu_sensor.gyroscope),
